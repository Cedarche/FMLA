...
from utils.torch_utils import select_device, load_image, preprocess_image
...
def run_test_pf(pipeline, person_img, clothing_img, device, save_dir):
...
def main(person_image_path, clothing_image_path, save_dir):
    device = select_device("cuda" if torch.cuda.is_available() else "cpu")

    # Define checkpoint paths assuming 'checkpoints' folder is in the same directory as the script
    ...
    run_test_pf(pipeline, person_img, clothing_img, device, save_dir)

if __name__ == "__main__":
    # Example usage
    main('path_to_person_image.jpg', 'path_to_clothing_image.jpg', 'path_to_save_dir')
